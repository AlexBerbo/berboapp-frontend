...
import { PageInvoiceUserState } from 'src/app/interface/appstate';
...
export class InvoicesComponent implements OnInit {
  invoiceState$: Observable<State<CustomHttpResponse<PageInvoiceUserState<Invoice>>>>;
  private dataSubject = new BehaviorSubject<CustomHttpResponse<PageInvoiceUserState<Invoice>>>(null);
  ...
  constructor(private router: Router, private invoiceService: InvoiceService, private notificationService: NotificationService) { }
