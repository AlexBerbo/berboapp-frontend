...
import { CustomHttpResponse, CustomerState } from 'src/app/interface/custom-http-resposne';
  ...
  ngOnInit(): void {
    this.customerState$ = this.activatedRoute.paramMap.pipe(
      switchMap((params: ParamMap) => {
        return this.customerService.getCustomer$(+params.get(this.CUSTOMER_ID)).pipe(map(response => {
